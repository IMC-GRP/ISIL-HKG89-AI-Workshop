...
namespace AI_Workshop.Application.UseCases.CloseTeamRegistration;

public class CloseTeamRegistrationUseCase
{
    ...
    public CloseTeamRegistrationUseCase(IWorkshopSettingsRepository workshopSettingsRepository, IWorkshopTeamRepository workshopTeamRepository)
    {
    ...
    {
        var settings = await _workshopSettingsRepository.SetTeamRegistrationOpenAsync(false);
        await _workshopTeamRepository.SetTeamRegistrationStateAsync(false, settings.TeamRegistrationCloseDate);
